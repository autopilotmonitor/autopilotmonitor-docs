...
* [How Autopilot Monitor Works](getting-started/how-it-works.md)
...
* [Session Details & Diagnosis](portal-guide/session-details-and-diagnosis.md)
* [Progress Portal](portal-guide/progress-portal.md)
* [Fleet Health](portal-guide/fleet-health.md)
* [Geographic Performance](portal-guide/geographic-performance.md)
* [SLA Compliance](portal-guide/sla-compliance.md)
* [Software Inventory & Vulnerabilities](portal-guide/software-inventory-and-vulnerabilities.md)
* [Usage Metrics](portal-guide/usage-metrics.md)
* [Audit Log & System Health](portal-guide/audit-log-and-system-health.md)

## Rules

* [How Rules Work Together](rules/overview.md)
* [Analyze Rules](rules/analyze-rules/README.md)
  * [Concepts](rules/analyze-rules/concepts.md)
  * [Built-in Rules Reference](rules/analyze-rules/built-in-rules.md)
  * [Template Rules](rules/analyze-rules/template-rules.md)
...
* [AI Integration (MCP)](integrations/ai-integration-mcp.md)

...
The product is currently in **Private Preview** — access is granted after approval, see [Requirements & Access](../getting-started/requirements-and-access.md). Pricing for general availability will be announced separately.

...
* Telemetry the backend cannot process is reported back to the agent instead of being silently lost: only the affected items are dropped and the rest of the batch is re-sent

...
* **Device phase and user phase in the app and script panels** — Download Progress, Install Progress and Script Executions draw a thin divider where the device entered Account Setup, so you see at a glance which apps and scripts started during the user part of the enrollment. See [Session Details](../portal-guide/session-details-and-diagnosis.md#session-detail).
